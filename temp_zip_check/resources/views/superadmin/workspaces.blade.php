...
<div class="content-panel">
    <div class="panel-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
        <div style="display: flex; align-items: center; gap: 15px;">
            ...
            <button type="button" class="btn btn-primary btn-sm" style="display: flex; align-items: center; gap: 5px; height: 32px; padding: 0 12px; border-radius: 6px;" onclick="document.getElementById('create-workspace-modal').showModal()">
                <i class='bx bx-plus'></i> Add Workspace
            </button>
        </div>
