...
Route::middleware(['auth', 'role:admin,superadmin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/directory/sync-erp', [AdminController::class, 'syncErpEmployees'])->name('directory.sync-erp');
...
Route::middleware(['auth', 'role:employee,admin,superadmin'])->prefix('employee')->name('employee.')->group(function () {
    ...
    Route::post('/face/register', [EmployeeController::class, 'registerFace'])->name('face.register');
