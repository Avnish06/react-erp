...
<div class="app-header">
    ...
    <div class="topbar-right">
        <a href="{{ route('employee.payslips.index') }}" class="btn btn-outline">Back to My Payslips</a>
...
<script>
    function downloadPDF() {
        ...
        // Hide button temporarily if it's inside the panel (it's not, it's in app-header)
        const opt = {
            margin:       10,
